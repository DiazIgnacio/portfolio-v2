  ...
  return (
    ...
    >
      ...
      <div className={`mx-auto mt-14 w-4/5 max-w-[660px] lg:mx-32`}>
        <h2
          className="leaading-5 text-lg font-normal md:text-xl md:leading-7 lg:text-3xl lg:leading-9"
          data-aos="fade-left"
          data-aos-delay="700"
        >
          I'm Ignacio
        ...
        <h1
          className="text-xl font-semibold leading-10 text-primary md:leading-[54px] lg:mt-1 lg:text-3xl lg:leading-[70px] xl:text-6xl"
          data-aos="fade-left"
          data-aos-delay="950"
        >
          Front End Developer
        ...
        <p
          className="mt-1 text-base leading-6 md:mt-3 md:text-lg md:leading-7 lg:mt-5 lg:text-xl lg:leading-8"
          data-aos="fade-left"
          data-aos-delay="1150"
        >
